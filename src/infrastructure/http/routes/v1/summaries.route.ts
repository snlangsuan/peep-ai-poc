...
import { monthlyDoc, periodDoc } from '#/features/summaries/v1/summary.openapi'
import { summaryMonthlyPayloadSchema, summaryPeriodPayloadSchema } from '#/features/summaries/v1/summary.schema'
...
summariesGroup.post('/period', periodDoc, zValidator('json', summaryPeriodPayloadSchema), controller.period)
