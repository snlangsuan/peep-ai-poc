...
ตอบกลับเป็น STRICT JSON เท่านั้น ห้ามมีข้อความอื่น ห้ามมี code fence:
{
  ...
  "love": { "reading": "คำทำนายดวงความรัก เขียนยาวอย่างน้อย 60 คำ", "caution": "สิ่งที่ควรระวังด้านความรัก (ถ้ามี)" },
  "finance": { "reading": "คำทำนายดวงการเงิน เขียนยาวอย่างน้อย 60 คำ", "caution": "สิ่งที่ควรระวังด้านการเงิน (ถ้ามี)" },
  "work": { "reading": "คำทำนายดวงการงาน เขียนยาวอย่างน้อย 60 คำ", "caution": "สิ่งที่ควรระวังด้านการงาน (ถ้ามี)" },
  "energy": "คำอธิบายพลังงานประจำวัน เขียนยาวอย่างน้อย 60 คำ",
  "energy_level": 4
}
ข้อกำหนด:
- tagline: ความยาว 50-80 ตัวอักษร
- love/finance/work: แต่ละด้านมี "reading" (คำทำนาย จำเป็นต้องมี) และ "caution" (สิ่งที่ควรระวัง)
- reading ของ love/finance/work และ energy: แต่ละช่องต้องมีความยาว "อย่างน้อย 60 คำ" เขียนให้มีเนื้อหา ลื่นไหล ให้กำลังใจ ลงรายละเอียด ห้ามสั้นกว่า 60 คำ
