...
ตอบกลับเป็น STRICT JSON เท่านั้น ห้ามมีข้อความอื่น ห้ามมี code fence:
{
  ...
  "love": { "reading": "คำทำนายดวงความรัก 1-2 ประโยค", "caution": "สิ่งที่ควรระวังด้านความรัก (ถ้ามี)" },
  "finance": { "reading": "คำทำนายดวงการเงิน 1-2 ประโยค", "caution": "สิ่งที่ควรระวังด้านการเงิน (ถ้ามี)" },
  "work": { "reading": "คำทำนายดวงการงาน 1-2 ประโยค", "caution": "สิ่งที่ควรระวังด้านการงาน (ถ้ามี)" },
  "energy": "คำอธิบายพลังงานประจำวัน 1 ประโยค",
  "energy_level": 4
}
ข้อกำหนด:
