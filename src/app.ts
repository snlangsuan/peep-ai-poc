...
import { errorHandler, notFoundHandler } from '~/src/infrastructure/http/middlewares/error.handler'
import { loggerMiddleware } from '~/src/infrastructure/http/middlewares/logger.middleware'
